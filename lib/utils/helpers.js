...
export function getJSCode(data, renderObject) {
  ...
  const legendAlignment =
    data['legend_layout'] === 'top' || data['legend_layout'] === 'bottom'
      ? data['legend_position_horizontal']
      : data['legend_position_vertical'];
  const legendOptions = data['legend_show']
    ? {
        show: data['legend_show'],
        position: data['legend_layout'],
  ...
  const prefix =
    (data.chart === 'default' || data.chart === 'metric') &&
    data['general_prefix']
      ? data['general_prefix']
      : undefined;
  const suffix =
    ...
    data['general_suffix']
      ? data['general_suffix']
      : undefined;
  const sparkline = data['appearance_sparkline']
    ? data['appearance_sparkline']
    : undefined;
  ...
  const table =
    (data['chart'] === 'default' || data['chart'] === 'table') &&
    data['table_pagination_show']
      ? {
          pagination: {
      ...
      : {};
  const choropleth =
    data['chart'] === 'default' || data['chart'] === 'choropleth'
      ? {
      ...
      : {};
  const funnel =
    data['chart'] === 'default' || funnels.includes(data['chart'])
      ? {
          ...
          percents: {
            ...
            decimals: data['funnel_percents_show']
              ? parseInt(data['funnel_percents_decimals'])
              : undefined
          },
