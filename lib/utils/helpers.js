...
export function getCSSRules(state) {
  return {
    ...
    chartFontSize: state['appearance.font.size'] !== 'auto' ? `font-size: ${state['appearance.font.size']}px;` : 'font-size: inherit;',
    chartFontBold: state['appearance.font.bold'] ? 'font-weight: bold;' : 'font-weight: inherit;',
    chartFontItalic: state['appearance.font.italic'] ? 'font-style: italic;' : 'font-style: inherit;',
    chartColor: state['appearance.color'] ? `color: ${state['appearance.color']};` : 'color: inherit;',
    ...
    seriesLabelTextAlign: `text-anchor: ${mapTextAnchor(state['series.label.textAlign'])} !important;`,
    ...
    tableHeaderFont: state['table.header.font.family'] ? `font-family: "${state['table.header.font.family']}";` : 'font-family: inherit;',
    tableHeaderFontSize: state['table.header.font.size'] !== 'auto' ? `font-size: ${state['table.header.font.size']}px;` : 'font-size: inherit;',
    tableHeaderFontBold: state['table.header.font.bold'] ? 'font-weight: bold;' : 'font-weight: inherit;',
    tableHeaderFontItalic: state['table.header.font.italic'] ? 'font-style: italic;' : 'font-style: inherit;',
    tableHeaderTextAlign: `text-align: ${state['table.header.textAlign']};`,
    tableHeaderColor: state['table.header.color'] ? `color: ${state['table.header.color']};` : 'color: inherit;',
    tableBodyFont: state['table.body.font.family'] ? `font-family: "${state['table.body.font.family']}";` : 'font-family: inherit;',
    tableBodyFontSize: state['table.body.font.size'] !== 'auto' ? `font-size: ${state['table.body.font.size']}px;` : 'font-size: inherit;',
    tableBodyFontBold: state['table.body.font.bold'] ? 'font-weight: bold;' : 'font-weight: inherit;',
    tableBodyFontItalic: state['table.body.font.italic'] ? 'font-style: italic;' : 'font-style: inherit;',
    tableBodyTextAlign: `text-align: ${state['table.body.textAlign']};`,
    tableBodyColor: state['table.body.color'] ? `color: ${state['table.body.color']};` : 'color: inherit;',
    tableBodyRowAltBackground: state['table.body.row.alternate.color'] ? `background-color: ${state['table.body.row.alternate.color']};` : 'background-color: inherit;',
    tableBodyRowHoverBackground: state['table.body.row.hover.background'] ? `background-color: ${state['table.body.row.hover.background']};` : 'background-color: inherit;',
  }
}
    ...
    case 'grid':
      ...
      case 'table':
        return limitDefaultState(state,
          ...
          'table.header.show',
          'table.header.textAlign',
          'table.header.color',
          'table.header.font.family',
          'table.header.font.size',
          'table.header.font.bold',
          'table.header.font.italic',
          'table.body.show',
          'table.body.textAlign',
          'table.body.color',
          'table.body.font.family',
          'table.body.font.size',
          'table.body.font.bold',
          'table.body.font.italic',
          'table.body.row.alternate.color',
          'table.body.row.hover.background',
          );
    default:
      return state;
  }
...
export function getDefaultState(type = '') {
  ...
  switch (type) {
    ...
    case 'metric':
      state = removeKeysFromState(defaultState, 'axis', 'legend', 'grid', 'series', 'tooltip', 'table');
      return {
        ...state,
      }
    case 'pie':
    case 'donut':
    case 'gauge':
      state = removeKeysFromState(defaultState, 'axis', 'grid', 'table');
      return {
        ...state,
        'series.label.show': true,
      }
    case 'gauge':
      state = removeKeysFromState(defaultState, 'axis', 'grid', 'legend', 'table');
      return {
        ...state,
      }
    case 'heatmap':
    case 'choropleth':
      state = removeKeysFromState(defaultState, 'axis', 'series', 'legend', 'gridline', 'table');
      return {
        ...state,
      }
    case 'funnel':
    ...
    case 'horizontal-funnel':
    case 'horizontal-funnel-3d':
      state = removeKeysFromState(defaultState, 'series', 'legend', 'grid', 'tooltip', 'table');
      return {
        ...state,
      }
    default:
