  ...
  return {
    ...
    chartFontSize:
      state['appearance_font_size'] !== 'auto'
        ...
        : 'font-size: inherit;',
    chartFontBold: state['appearance_font_bold']
      ? 'font-weight: bold;'
      : 'font-weight: inherit;',
    ...
    titleFontSize:
      state['title_font_size'] !== 'auto'
        ...
        : 'font-size: inherit;',
    titleFontBold: state['title_font_bold']
      ? 'font-weight: bold;'
      : 'font-weight: inherit;',
    titleFontItalic: state['title_font_italic']
      ? 'font-style: italic;'
      : 'font-style: inherit;',
    ...
    subtitleFontSize:
      state['subtitle_font_size'] !== 'auto'
        ...
        : 'font-size: inherit;',
    subtitleFontBold: state['subtitle_font_bold']
      ? 'font-weight: bold;'
      : 'font-weight: inherit;',
    ...
    legendFontSize:
      state['legend_font_size'] !== 'auto'
        ...
        : 'font-size: inherit;',
    legendFontBold: state['legend_font_bold']
      ? 'font-weight: bold;'
      : 'font-weight: inherit;',
    legendFontItalic: state['legend_font_italic']
      ? 'font-style: italic;'
      : 'font-style: inherit;',
    ...
    tooltipFontSize:
      state['tooltip_font_size'] !== 'auto'
        ...
        : 'font-size: inherit;',
    tooltipFontBold: state['tooltip_font_bold']
      ? 'font-weight: bold;'
      : 'font-weight: inherit;',
...
export function getJSCode(data, renderObject) {
  ...
  const legendAlignment = (data['legend_layout'] === 'top' || data['legend_layout'] === 'bottom')
      ? data['legend_position_horizontal'] : data['legend_position_vertical'];
  const legendOptions = data['legend_show'] ? { show: data['legend_show'], position: data['legend_layout'], alignment: legendAlignment} : { show: data['legend_show']};
  ...
  const prefix = ((data.chart === 'default' || data.chart === 'metric') && data['general_prefix']) ? data['general_prefix'] : undefined;
  const suffix = ((data.chart === 'default' || data.chart === 'metric') && data['general_suffix']) ? data['general_suffix'] : undefined;
  ...
  const simpleTooltip = data['tooltip_simpleTooltip'] ? true : false;
  const table = (data['chart'] === 'default' || data['chart'] === 'table') && data['table_pagination_show'] ?
  {
    pagination: {
      limit: parseInt(data['table_pagination_limit'])
    }
  } : {};
  const choropleth = (data['chart'] === 'default' || data['chart'] === 'choropleth') ?
  {
  ...
  const funnel = (data['chart'] === 'default' || funnels.includes(data['chart'])) ?
  {
    ...
    percents: {
      ...
      decimals: data['funnel_percents_show'] ? parseInt(data['funnel_percents_decimals']) : undefined,
    },
  ...
  let heatmapOptions;
  if (data['chart'] === 'default' || data['chart'] === 'heatmap') {
    heatmapOptions = {
      showSlider: slider,
