...
export default class Builder extends Component {
  ...
  handleClickOnCover = () => {
    this.setState({ activePickerId: '' }, this.dispatchChange());
  }
  ...
  handleChartTypeChange = (e) => {
    ...
    this.setState({ chartType: e.target.value }, this.dispatchChange());
  }
  ...
  handleChartPaletteChange = (e) => {
    ...
    this.setState({ chartPalette: palette, colors: chartColorPalette[palette] || [] }, this.dispatchChange());
  }
  ...
  renderMockUpSection() {
    ...
    const tabChart = this.state.chartType === 'default' ? this.renderDefaultCharts() : this.renderChart();
    return (
