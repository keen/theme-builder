...
export default class Builder extends PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const obj = isDashboardBuilderActive
      ? { theme: cur, style: minifiedStyle, options: getJSCode(cur, true) }
      : cur;
        ...
        {!isDashboardBuilderActive && (
          <div className="accordion__item__row">
            <FormInput
              ...
              onChange={e =>
                this.handleTextStateUpdate('title_text', e.target.value)
              }
            />
          </div>
        )}
        ...
        {!isDashboardBuilderActive && (
          <div className="accordion__item__row">
            <FormInput
              ...
              onChange={e =>
                this.handleTextStateUpdate('subtitle_text', e.target.value)
              }
            />
          </div>
        )}
    ...
    return (
      <div className="keen-theme-builder__row two-elements">
        <FormInput
          ...
          onChange={e =>
            this.handleTextStateUpdate('general_prefix', e.target.value)
          }
        />
        <FormInput
          key="metric-suffix"
          ...
          onChange={e =>
            this.handleTextStateUpdate('general_suffix', e.target.value)
          }
        />
      </div>
    );
