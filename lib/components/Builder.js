...
export default class Builder extends PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const obj = isDashboardBuilderActive ? { theme: cur, options: getJSCode(cur, true) } : cur;
      ...
      <>
        { chart !== 'default' && 
          <div className="accordion__item__row">
            <FormInput key="title" type="text" name="title" value={this.state['title_text']} onChange={e => {this.handleTextStateUpdate('title_text', e)}} />
          </div>
        }
  ...
  renderSubtitleSection() {
    ...
    return (
      <>
        { chart !== 'default' &&
          <div className="accordion__item__row">
            <FormInput key="subtitle" type="text" name="subtitle" value={this.state['subtitle_text']} onChange={e => this.handleTextStateUpdate('subtitle_text', e)} />
          </div>
        }
  ...
  renderVerticalAxisTitleSection() {
    return (
      <>
        <div className="accordion__item__row">
          <FormInput key="vertical-axis-title" type="text" name="vertical-axis-title" value={this.state['axis_vertical_title_text']} onChange={e => this.handleTextStateUpdate('axis_vertical_title_text', e)} />
        </div>
  ...
  renderHorizontalAxisTitleSection() {
    return (
      <>
        <div className="accordion__item__row">
          <FormInput key="horizotanl-axis-title" type="text" name="horizontal-axis-title" value={this.state['axis_horizontal_title_text']} onChange={e => this.handleTextStateUpdate('axis_horizontal_title_text', e)} />
        </div>
  ...
  renderMetricOptions() {
    return (
      <div className="keen-theme-builder__row two-elements">
        <FormInput key="metric-prefix" type="text" label="Prefix" name="metric-prefix" value={this.state['general_prefix']} onChange={e => this.handleTextStateUpdate('general_prefix', e)} />
        <FormInput key="metric-suffix" type="text" label="Suffix" name="metric-suffix" value={this.state['general_suffix']} onChange={e => this.handleTextStateUpdate('general_suffix', e)} />
      </div>
    );
  }
  ...
  renderFunnelPercentsSection() {
    ...
    return (
      <>
        ...
        <div className="accordion__item__row">
          <FormInput key="funnel-percents-decimals" type="text" label="Decimals" name="funnel-percents-decimals" value={this.state['funnel_percents_decimals']} onChange={e => this.handleTextStateUpdate('funnel_percents_decimals', e)} maxLength="2" />
        </div>
      </>
    );
  }
        ...
        <Accordion>
          ...
          {sections.axis && (
            <div label="Vertical axis">
              ...
              { chart !== 'default' && this.state['axis_vertical_title_show'] && this.renderVerticalAxisTitleSection()}
          ...
          {sections.axis && (
            <div label="Horizontal axis">
              ...
              { chart !== 'default' && this.state['axis_horizontal_title_show'] && this.renderHorizontalAxisTitleSection()}
          ...
          {sections.table && (
            <div label="Table">
              ...
              {this.state['table_pagination_show'] && (
                <div className="accordion__item__row">
                  <FormInput key="table-pagination" type="text" label="Pagination limit" name="table-pagination" value={this.state['table_pagination_limit']} onChange={e => this.handleTextStateUpdate('table_pagination_limit', e)} maxLength="2" />
                </div>
              )}
              <Switcher
          ...
          {sections.funnel && (
            <div label="Funnel">
              ...
              <div className="accordion__item__row">
                <FormInput key="funnel-minimal-size" type="number" label="Minimal size" name="funnel-minimal-size" value={this.state['funnel_minimal_size']} onChange={e => this.handleTextStateUpdate('funnel_minimal_size', e)} />
              </div>
