  ...
  renderLegendSection() {
    ...
    return (
      <>
        ...
        <div className="accordion__item__row disabled">
      ...
      <section className="builder__config">
        <Accordion>
          ...
          <div label="Title & Subtitle">
            ...
            <Switcher className="disabled" checked={!!this.state['subtitle.show']} onChange={() => this.handleStateChange('subtitle.show', !this.state['subtitle.show'])} text={{ on: 'Show', off: 'Hide' }}>
              <span className="section-title">Subtitle</span>
            </Switcher>
            {this.state['subtitle.show'] && this.renderSubtitleSection()}
          </div>
          <div label="Vertical axis">
            <Switcher className="disabled" checked={!!this.state['axis.vertical.title.show']} onChange={() => this.handleStateChange('axis.vertical.title.show', !this.state['axis.vertical.title.show'])}>
          ...
          <div label="Horizontal axis">
            <Switcher className="disabled" checked={!!this.state['axis.horizontal.title.show']} onChange={() => this.handleStateChange('axis.horizontal.title.show', !this.state['axis.horizontal.title.show'])}>
              <span className="section-title">Axis title</span>
            </Switcher>
