...
export default class Builder extends PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const obj = isDashboardBuilderActive ? { theme: cur, style: getCSSCode(cur), options: getJSCode(cur, 'object') } : cur;
        ...
        <Accordion>
          ...
          {sections.axis &&
            <div label="Vertical axis">
              ...
              {this.state['axis_vertical_title_show'] && this.renderVerticalAxisTitleSection()}
          ...
          {sections.axis &&
            <div label="Horizontal axis">
              ...
              {this.state['axis_horizontal_title_show'] && this.renderHorizontalAxisTitleSection()}
